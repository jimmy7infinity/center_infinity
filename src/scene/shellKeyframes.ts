...
export const SHELL_MOTIONS: ShellMotion[] = [
  {
    ...
    keyframes: [
      ...
      },
      {
        ...
        lightDir: lightFromAbove(-0.14, -0.26),
        intensity: 0.78,
      },
      {
        at: 0.45,
        position: [2.4, 0.95, -0.9],
        lightDir: lightFromAbove(-0.55, -0.18),
        intensity: 0.82,
      },
      {
        at: 0.7,
        position: [3.8, -0.35, 1.1],
        lightDir: lightFromAbove(0.35, -0.42),
        intensity: 0.74,
      },
      {
        at: 1,
        position: [4.6, -1.15, 2.4],
        lightDir: lightFromAbove(0.48, -0.48),
        intensity: 0.7,
      },
    ],
  },
  {
    ...
    keyframes: [
      ...
      },
      {
        ...
        lightDir: lightFromAbove(0.08, -0.28),
        intensity: 0.76,
      },
      {
        at: 0.45,
        position: [-2.2, 1.65, -0.4],
        lightDir: lightFromAbove(0.62, -0.22),
        intensity: 0.84,
      },
      {
        at: 0.7,
        position: [-3.5, 0.15, 1.4],
        lightDir: lightFromAbove(-0.28, -0.44),
        intensity: 0.76,
      },
      {
        at: 1,
        position: [-4.2, -0.95, 2.8],
        lightDir: lightFromAbove(-0.42, -0.5),
        intensity: 0.72,
      },
    ],
  },
  {
    ...
    keyframes: [
      ...
      },
      {
        ...
        lightDir: lightFromBelow(-0.04, -0.26),
        intensity: 0.77,
      },
      {
        at: 0.45,
        position: [-1.8, -2.35, -0.2],
        lightDir: lightFromBelow(-0.58, -0.16),
        intensity: 0.8,
      },
      {
        at: 0.7,
        position: [0.6, -3.1, 1.5],
        lightDir: lightFromBelow(0.32, -0.4),
        intensity: 0.72,
      },
      {
        at: 1,
        position: [2.0, -1.85, 3.0],
        lightDir: lightFromBelow(0.45, -0.46),
        intensity: 0.68,
      },
    ],
  },
  {
    ...
    keyframes: [
      ...
      },
      {
        ...
        lightDir: lightFromBelow(-0.06, -0.24),
        intensity: 0.78,
      },
      {
        at: 0.45,
        position: [1.4, -2.15, 0.35],
        lightDir: lightFromBelow(0.52, -0.18),
        intensity: 0.82,
      },
      {
        at: 0.7,
        position: [2.8, -0.65, 2.0],
        lightDir: lightFromBelow(-0.22, -0.38),
        intensity: 0.74,
      },
      {
        at: 1,
        position: [3.4, 0.35, 3.5],
        lightDir: lightFromBelow(-0.38, -0.44),
        intensity: 0.7,
      },
    ],
  },
